...
class ServicePraticien {
    ...
    fun getLesPraticiens(token: String?): ReponsePraticien {
        ...
        var json = URL("http://192.168.1.31/api/json/praticien/listePraticien?token=" + token).readText()
        val gson = Gson()
    ...
    fun getLesPraticiensType(token: String?, idType: String): ReponsePraticien {
        val policy = StrictMode.ThreadPolicy.Builder().permitAll().build()
        StrictMode.setThreadPolicy(policy)
        var json = URL("http://192.168.1.31/api/json/praticien/listePraticienNomType?token=" + token + "&type=" + idType).readText()
        val gson = Gson()
        var Reponse: ReponsePraticien = gson.fromJson(json, ReponsePraticien::class.java)
        return Reponse
    }
    fun getLesPraticiensNom(token: String?, nomPraticien: String): ReponsePraticien {
        val policy = StrictMode.ThreadPolicy.Builder().permitAll().build()
        StrictMode.setThreadPolicy(policy)
        var json = URL("http://192.168.1.31/api/json/praticien/listePraticienNomType?token=" + token + "&nomPraticien=" + nomPraticien).readText()
        val gson = Gson()
        var Reponse: ReponsePraticien = gson.fromJson(json, ReponsePraticien::class.java)
        return Reponse
    }
    fun getLesPraticiensNomType(token: String?, idType: String, nomPraticien: String): ReponsePraticien {
        val policy = StrictMode.ThreadPolicy.Builder().permitAll().build()
        StrictMode.setThreadPolicy(policy)
        var json = URL("http://192.168.1.31/api/json/praticien/listePraticienNomType?token=" + token + "&type=" + idType + "&nomPraticien=" + nomPraticien).readText()
        val gson = Gson()
        var Reponse: ReponsePraticien = gson.fromJson(json, ReponsePraticien::class.java)
        return Reponse
    }
    ...
    fun getLesTypes(token: String?): ReponseTypes {
        val policy = StrictMode.ThreadPolicy.Builder().permitAll().build()
        StrictMode.setThreadPolicy(policy)
        var json = URL("http://192.168.1.31/api/json/praticien/listeTypes?token=" + token).readText()
        val gson = Gson()
